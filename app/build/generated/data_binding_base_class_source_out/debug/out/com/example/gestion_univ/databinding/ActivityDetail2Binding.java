...
public final class ActivityDetail2Binding implements ViewBinding {
  ...
  private ActivityDetail2Binding(@NonNull RelativeLayout rootView,
      @NonNull FloatingActionButton deleteButtonCours, @NonNull TextView detailDescriptionCours,
      ...
      @NonNull TextView labelDescriptionCours, @NonNull TextView labelNiveauCours,
      @NonNull TextView labelNom, @NonNull TextView labelNumeroID,
      @NonNull TextView labelParcoursCours, @NonNull TextView labelSalleCours,
  ...
  public static ActivityDetail2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetail2Binding((RelativeLayout) rootView, deleteButtonCours,
          detailDescriptionCours, detailNiveauCours, detailNomCours, detailNumeroCours,
          detailParcoursCours, detailSalleCours, editButtonCours, labelDescriptionCours,
          labelNiveauCours, labelNom, labelNumeroID, labelParcoursCours, labelSalleCours, main);
    }
