...
public final class ActivityEditProfilBinding implements ViewBinding {
  ...
  private ActivityEditProfilBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
      @NonNull EditText editName, @NonNull ActivityFn5ContentBinding include2,
  ...
  public static ActivityEditProfilBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditProfilBinding((ConstraintLayout) rootView, btnSave, editName,
