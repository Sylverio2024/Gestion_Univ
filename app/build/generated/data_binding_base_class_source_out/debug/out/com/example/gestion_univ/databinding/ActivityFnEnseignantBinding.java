...
public final class ActivityFnEnseignantBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityFnEnseignantBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFnEnseignantBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fn_enseignant, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFnEnseignantBinding bind(@NonNull View rootView) {
