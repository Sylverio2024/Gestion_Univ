...
public final class ActivityMainContentBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton buttonDrawerToggle;

  @NonNull
  public final Toolbar toolbar;

  private ActivityMainContentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton buttonDrawerToggle, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMainContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageButton buttonDrawerToggle = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainContentBinding((ConstraintLayout) rootView, buttonDrawerToggle,
          toolbar);
    }
