...
public final class DialogImageBinding implements ViewBinding {
  ...
  private DialogImageBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imageViewLarge) {
  ...
  public static DialogImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogImageBinding((RelativeLayout) rootView, imageViewLarge);
    }
