...
public class AdapterCours extends RecyclerView.Adapter<MyViewHolderCours> {

    private Context context2;
    private List<DataClass2> dataList2;

    public AdapterCours(Context context2, List<DataClass2> dataList2) {
    ...
    @NonNull
    @Override
    public MyViewHolderCours onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_cours, parent, false);
        return new MyViewHolderCours(view2);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolderCours holder, int position) {
        ...
        holder.recCard2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context2, DetailActivityCours.class);
