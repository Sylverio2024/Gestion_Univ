...
public class DetailActivityEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter1(this, imageUrls, imageUrl -> {
            ...
            Intent intent = new Intent(DetailActivityEvent.this, FullScreenImageActivity1.class);
        ...
        editButton.setOnClickListener(v -> {
            Intent intent = new Intent(DetailActivityEvent.this, updateEvent.class);
                    ...
                    databaseReference.child(key4).removeValue()
                            .addOnSuccessListener(aVoid -> {
                                ...
                                if (imageUrls != null && !imageUrls.isEmpty()) {
                                    ...
                                    Toast.makeText(DetailActivityEvent.this, "Événement supprimé avec succès", Toast.LENGTH_SHORT).show();
                                    finish();  // Retour à la liste des événements
                                }
                            })
                            .addOnFailureListener(e -> {
                                Toast.makeText(DetailActivityEvent.this, "Erreur lors de la suppression de l'événement", Toast.LENGTH_SHORT).show();
                            });
                } else {
                    // L'événement n'existe pas dans la base de données
                    Toast.makeText(DetailActivityEvent.this, "L'événement n'existe pas ou a déjà été supprimé", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DetailActivityEvent.this, "Erreur lors de la récupération de l'événement", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deleteEventImages(List<String> imageUrls) {
        for (String imageUrl : imageUrls) {
            ...
            imageRef.delete()
                    ...
                    .addOnFailureListener(e -> Toast.makeText(DetailActivityEvent.this, "Erreur lors de la suppression des images", Toast.LENGTH_SHORT).show());
        }
        // Retour à la liste des événements après la suppression des images
        Toast.makeText(DetailActivityEvent.this, "Événement et images supprimés avec succès", Toast.LENGTH_SHORT).show();
        finish();  // Retour à la liste des événements
    }
}