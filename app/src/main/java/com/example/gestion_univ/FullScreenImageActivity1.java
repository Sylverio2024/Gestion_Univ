...
public class FullScreenImageActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_screen_image1);
    ...
    private void uploadImageToFirebase() {
        if (imageUri != null) {
            ...
            fileReference.putFile(imageUri)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(FullScreenImageActivity1.this, "Échec de l'upload", Toast.LENGTH_SHORT).show());
        } else {
    ...
    private void updateImageUrlInDatabase(String newImageUrl) {
        ...
        databaseReference.child(key4).child("imagesEvent").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    if (index != -1) {
                        ...
                        databaseReference.child(key4).child("imagesEvent").setValue(imageUrls)
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(FullScreenImageActivity1.this, "Image mise à jour avec succès", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(FullScreenImageActivity1.this, Evenement.class);
                                    startActivity(intent);
                                    finish(); // Retour à l'activité précédente

                                })
                                .addOnFailureListener(e -> Toast.makeText(FullScreenImageActivity1.this, "Erreur lors de la mise à jour de l'image", Toast.LENGTH_SHORT).show());
                    }
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FullScreenImageActivity1.this, "Erreur lors de la récupération des images", Toast.LENGTH_SHORT).show();
            }
        });
    }
}